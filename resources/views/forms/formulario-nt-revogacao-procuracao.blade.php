    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 text-center mb-5">
                <h2 class="heading-section">FORMULÁRIO NT - REVOGAÇÃO DE PROCURAÇÃO</h2>
            </div>
        </div>
        <form method="POST" id="formDocument" name="formDocument" class="formDocument">
            ...
            <div class="row">
                <h6 class="text-white mt-2">{{$LABELS::DADOS_PROCURACAO}}</h6>
                <div class="col-md-12 d-flex justify-content-between">
                    <div class="form-group w-50 pr-1">
                        <label class="text-white">{{$LABELS::CARTORIO}} *</label>
                        <input type="text" class="form-control" name="{{$INPUTS::CARTORIO_PROCURACAO}}" id="{{$INPUTS::CARTORIO_PROCURACAO}}" placeholder="{{$PLACEHOLDER::CARTORIO}}" field="{{$LABELS::CARTORIO}}" data-request="true">
                    </div>
                    <div class="form-group w-50 pl-1">
                        <label class="text-white">{{$LABELS::DATA}} *</label>
                        <input type="date" class="form-control" name="{{$INPUTS::DATA_PROCURACAO}}" id="{{$INPUTS::DATA_PROCURACAO}}" field="{{$LABELS::DATA}}" data-request="true">
                    </div>
                </div>
                <div class="col-md-12 d-flex justify-content-between">
                    <div class="form-group w-50 pr-1">
                        <label class="text-white">{{$LABELS::LIVRO}} *</label>
                        <input type="text" class="form-control" name="{{$INPUTS::LIVRO_PROCURACAO}}" id="{{$INPUTS::LIVRO_PROCURACAO}}" placeholder="{{$PLACEHOLDER::LIVRO}}" field="{{$LABELS::LIVRO}}" data-request="true">
                    </div>
                    <div class="form-group w-50 pl-1">
                        <label class="text-white">{{$LABELS::FOLHAS}} *</label>
                        <input type="text" class="form-control" name="{{$INPUTS::FOLHAS_PROCURACAO}}" id="{{$INPUTS::FOLHAS_PROCURACAO}}" placeholder="{{$PLACEHOLDER::FOLHAS}}" field="{{$LABELS::FOLHAS}}" data-request="true">
                    </div>
                </div>

                <h6 class="text-white mt-2">{{$LABELS::DADOS_PROCURACAO_REVOGACAO}}</h6>
                <div class="col-md-12 d-flex justify-content-between">
                    <div class="form-group w-50 pr-1">
                        <label class="text-white">{{$LABELS::CARTORIO}} *</label>
                        <input type="text" class="form-control" name="{{$INPUTS::CARTORIO_REVOGACAO}}" id="{{$INPUTS::CARTORIO_REVOGACAO}}" placeholder="{{$PLACEHOLDER::CARTORIO}}" field="{{$LABELS::CARTORIO}}" data-request="true">
                    </div>
                    <div class="form-group w-50 pl-1">
                        <label class="text-white">{{$LABELS::DATA}} *</label>
                        <input type="date" class="form-control" name="{{$INPUTS::DATA_REVOGACAO}}" id="{{$INPUTS::DATA_REVOGACAO}}" field="{{$LABELS::DATA}}" data-request="true">
                    </div>
                </div>
                <div class="col-md-12 d-flex justify-content-between">
                    <div class="form-group w-50 pr-1">
                        <label class="text-white">{{$LABELS::LIVRO}} *</label>
                        <input type="text" class="form-control" name="{{$INPUTS::LIVRO_REVOGACAO}}" id="{{$INPUTS::LIVRO_REVOGACAO}}" placeholder="{{$PLACEHOLDER::LIVRO}}" field="{{$LABELS::LIVRO}}" data-request="true">
                    </div>
                    <div class="form-group w-50 pl-1">
                        <label class="text-white">{{$LABELS::FOLHAS}} *</label>
                        <input type="text" class="form-control" name="{{$INPUTS::FOLHAS_REVOGACAO}}" id="{{$INPUTS::FOLHAS_REVOGACAO}}" placeholder="{{$PLACEHOLDER::FOLHAS}}" field="{{$LABELS::FOLHAS}}" data-request="true">
                    </div>
                </div>
            </div>
            @include('forms.buttons-footer', ['actionRoute' => '/NT/NT-RDP', 'backRoute' => '/NT'])
        </form>
    </div>
</section>