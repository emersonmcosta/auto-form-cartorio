    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 text-center mb-5">
                <h2 class="heading-section">FORMULÁRIO NT - ABANDONO DE EMPREGO</h2>
            </div>
        </div>
        <form method="POST" id="formDocument" name="formDocument" class="formDocument">
            ...
            <div class="row">
                ...
                <div class="col-md-12 d-flex justify-content-between">
                    <div class="form-group w-50 pr-1">
                        <label class="text-white">{{$LABELS::DATA_AUSENCIA}}</label>
                        <input type="date" class="form-control" name="{{$INPUTS::DATA_AUSENCIA}}" id="{{$INPUTS::DATA_AUSENCIA}}" field="{{$LABELS::DATA_AUSENCIA}}" data-request="true">
                    </div>
                </div>
            </div>
            @include('forms.buttons-footer', ['actionRoute' => '/NT/NT-ADE', 'backRoute' => '/NT'])
        </form>
    </div>
</section>