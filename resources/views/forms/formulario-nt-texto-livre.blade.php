    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10 text-center mb-5">
                <h2 class="heading-section">FORMULÁRIO NT - TEXTO LIVRE</h2>
            </div>
        </div>
        <form method="POST" id="formDocument" name="formDocument" class="formDocument">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="text-white">{{$LABELS::TEXTO_LIVRE}} *</label>
                        <textarea type="date" class="form-control" 
                            name="{{$INPUTS::TEXTO_LIVRE}}" 
                            id="{{$INPUTS::TEXTO_LIVRE}}" rows="10" field="{{$LABELS::TEXTO_LIVRE}}" data-request="true"></textarea>
                    </div>
                </div>
            </div>
            @include('forms.buttons-footer', ['actionRoute' => '/NT/NT-TL', 'backRoute' => '/NT'])
        </form>
    </div>
</section>