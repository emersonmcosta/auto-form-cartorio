...
<body>
    <div class="container mt-4 mb-4">
        ...
        <form id="formDocument" method="POST" enctype="multipart/form-data" action="/PET/guarda-individual-animal-domestico">
            @csrf
            <!-- Foto do Animal -->
            ...
            <div class="form-section">
                <div class="row">
                    <h5 class="form-title">Informações do Tutor</h5>
                    ...
                    <div class="mb-3 col-4">
                        <label>CPF:</label>
                        <input type="text" class="form-control cpf_cnpj" name="cpf">
                    </div>
                </div>
            </div>
            <hr/>
            ...
            <div class="form-section row">
                <div class="col-12">
                    <div class="form-title">Assinatura do Tutor</div>
                    <p>______________________________</p>
                </div>
            </div>

            @include('forms.buttons-footer', ['actionRoute' => '/PET/guarda-individual-animal-domestico', 'backRoute' => '/PET'])
