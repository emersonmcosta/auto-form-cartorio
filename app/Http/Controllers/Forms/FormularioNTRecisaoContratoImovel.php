...
class FormularioNTRecisaoContratoImovel extends Controller
{
    ...
    public function index()
    {
        ...
        return view('forms.formulario-nt-resicao-contratual-imovel', compact('LABELS', 'PLACEHOLDER', 'INPUTS'));
    }

    public function createDocument(Request $request)
    {
        // Caminho do arquivo modelo (coloque o arquivo .docx em 'storage/app/public/modelos/NT-RLI.docx')
        $modeloPath = storage_path('app/public/modelos/NT-RLI.docx');
        ...
        $templateProcessor->setValues(['dados_endereco_imovel' => $request->input('dados_endereco_imovel')]);
        ...
        Util::sendServiceNotification("FORMULÁRIO NT - RESIÇÃO CONTRATUAL LOCAÇÃO DE IMÓVEL",$tempPath);
