...
class FormularioNTDesocupacaoVoluntariaImovel extends Controller
{
    ...
    public function index()
    {
        ...
        return view('forms.formulario-nt-desocupacao-voluntaria-imovel', compact('LABELS', 'PLACEHOLDER', 'INPUTS'));
    }

    public function createDocument(Request $request)
    {
        // Caminho do arquivo modelo (coloque o arquivo .docx em 'storage/app/public/modelos/NT-DVBI.docx')
        $modeloPath = storage_path('app/public/modelos/NT-DVBI.docx');
        ...
        Util::sendServiceNotification("FORMULÁRIO NT - DESOCUPAÇÃO VOLUNTÁRIA DO BEM IMÓVEL",$tempPath);
